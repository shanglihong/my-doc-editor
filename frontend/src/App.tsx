...
import type { DocEditorRef, DocumentNode } from './components/DocEditor';
import { ThemeToggle } from './components/ThemeToggle';
import './App.css';

export function App() {
  const editorRef = useRef<DocEditorRef>(null);
  const [docJson, setDocJson] = useState<DocumentNode | null>(null);
